/*******************************************
*
* @file MergeArgOptions.hh
*
* @brief Defines MergeArgOptions.
*
********************************************/

#ifndef MERGEARGOPTIONS_HH
#define MERGEARGOPTIONS_HH 1
 ...
 *******************************************************/
class MergeArgOptions{

    public:
        /**
         * @brief Constructor of MergeArgOptions.
         * @param argc \c argc of the main function.
         * @param argv \c argv of the main function.
         */
        MergeArgOptions(int &argc, char **argv) {
